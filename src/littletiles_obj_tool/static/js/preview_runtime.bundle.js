var LTPreviewRuntime = (() => {
  ...
  // src/littletiles_obj_tool/static/js/preview_runtime.js
  var preview_runtime_exports = {};
  __export(preview_runtime_exports, {
    createPreviewRuntime: () => createPreviewRuntime
  });

  // src/littletiles_obj_tool/static/vendor/three/build/three.module.js
  var REVISION = "165";
...
void main() {
  ...
  // src/littletiles_obj_tool/static/vendor/three/examples/jsm/controls/OrbitControls.js
  ...
  // src/littletiles_obj_tool/static/vendor/three/examples/jsm/loaders/OBJLoader.js
  ...
  // src/littletiles_obj_tool/static/vendor/three/examples/jsm/loaders/MTLLoader.js
  ...
  // src/littletiles_obj_tool/static/js/preview_runtime.js
  function createPreviewRuntime({ viewer, viewerEmpty, getCurrentColor }) {
    const renderer = new WebGLRenderer({ antialias: true });
    renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2));
    viewer.appendChild(renderer.domElement);
    const scene = new Scene();
    scene.background = new Color("#ede1cf");
    const camera = new PerspectiveCamera(50, 1, 0.01, 5e3);
    ...
    const hemi = new HemisphereLight(16777215, 10388580, 1.1);
    scene.add(hemi);
    const keyLight = new DirectionalLight(16777215, 1.4);
    keyLight.position.set(14, 20, 10);
    scene.add(keyLight);
    const fillLight = new DirectionalLight(16773854, 0.6);
    fillLight.position.set(-12, 10, -10);
    scene.add(fillLight);
    const gridHelper = new GridHelper(64, 64, 9264431, 12956830);
    ...
    function frameObject(object) {
      ...
      camera.near = Math.max(maxDim / 1e3, 0.01);
    ...
    function installWireOverlay(root) {
      root.traverse((child) => {
        ...
        const line = new LineSegments(
          edges,
          new LineBasicMaterial({ color: 4010277, transparent: true, opacity: 0.22 })
        );
        child.add(line);
      });
    }
  ...
  return __toCommonJS(preview_runtime_exports);
})();
/**
 * @license
